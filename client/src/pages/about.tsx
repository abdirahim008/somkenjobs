        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 lg:max-w-4xl space-y-12">
            ...
            <div id="features" className="relative">
              ...
              {/* Visual Flow Diagram */}
              <div className="relative bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-8 mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-white rounded-lg shadow-sm border">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-2">
                    <svg className="w-6 h-6 text-[#0077B5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm border">
                  ...
                  <div className="text-sm font-medium">Verified Jobs</div>
                </div>
                ...
                <div className="text-center p-4 bg-white rounded-lg shadow-sm border">
                  ...
                  <div className="text-sm font-medium">Fast Apply</div>
                </div>
              </div>
