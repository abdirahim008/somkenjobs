      ...
      return `
        <div class="flex flex-col gap-4">
          ...
          <a href="${url}" target="_blank" rel="noopener noreferrer" 
             class="inline-flex items-center justify-center gap-2 px-6 py-3 text-white font-medium rounded-lg transition-colors duration-200 w-auto max-w-xs"
             style="background-color: #005885; border: none;"
             onmouseover="this.style.backgroundColor='#004472'"
             onmouseout="this.style.backgroundColor='#005885'">
